<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewDocument.aspx.cs" Inherits="HRMSAdminModule.AdminViewDocument" %>
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%# Eval("EmpFirstName") %></td>
                                                        <td><%# Eval("EmpLastName") %></td>
                                                        <td><%# Eval("Department") %></td>
                                                        <td><%# Eval("DocId") %></td>
                                                        <td><%# Eval("DocName") %></td>
                                                        <td>
                                                           
                                                            <asp:HyperLink ID="HyperLink1" runat="server" CommandName="ViewDocument"
                                                                CommandArgument='<%# Eval("DocID") %>'>View Document</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
