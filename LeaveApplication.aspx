<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveApplication.aspx.cs" Inherits="HRMSAdminModule.LeaveApplication" %>
                                ...
                                <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                    <div class="dropdown-content-body">
                                        <ul>
                                            ...
                                            <li><a href="SignIn.aspx"><i class="icon-key"></i><span>Logout</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="nk-nav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./LeaveApplication.aspx" aria-expanded="false">Apply Leave</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox5" runat="server" class="form-control input-flat" placeholder="From Date" TextMode="Date"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox1" runat="server" class="form-control input-flat" placeholder="To Date" TextMode="Date"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox2" runat="server" class="form-control input-flat" placeholder="Reason"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <asp:Button ID="Button1" runat="server" class="btn btn-dark" Text="Apply" OnClick="Button1_Click" />
                                        </div>
