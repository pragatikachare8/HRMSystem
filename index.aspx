<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="HRMSAdminModule.index" %>
        ...
        <div class="row">
                ...
                <div class="card gradient-1">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white">
                                <asp:Label runat="server" ID="txtEmpCount"></asp:Label>
                            </h2>
                            <p class="text-white mb-0">Jan-Dec-2024</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <div class="card-body">
                        <h3 class="card-title text-white">Avg Check-In Time</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">9:30 AM</h2>
                            <p class="text-white mb-0">Nov-Dec 2024</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <div class="card-body">
                        <h3 class="card-title text-white">Avg Check-In Time</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">6:30 PM</h2>
                            <p class="text-white mb-0">Nov-Dec 2024</p>
                        </div>
                        <span class="float-right display-5 opacity-5"><i class="fa fa-clock-o"></i></span>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Working Hrs</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">9:00 Hrs</h2>
                            <p class="text-white mb-0">Nov-Dec 2024</p>
                        </div>
