<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addEvents.aspx.cs" Inherits="HRMSAdminModule.addEvents" %>
 ...
 ***********************************-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                        <label for="DropDownList2">Event Type:</label>
                                        <asp:DropDownList
                                            ID="DropDownList2"
                                            runat="server"
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="Button2" runat="server" class="btn btn-dark" Text="Create Event" OnClick="Button1_Click1" />
                                    </div>
                                </div>
                            </div>
  ...
  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:P_HRMSConnectionString2 %>" ProviderName="<%$ ConnectionStrings:P_HRMSConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [Event]" UpdateCommand="UPDATE [Event] SET eName = @eName, eType = @eType, Email = @Email WHERE eventId = @eventId"
