<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateEmployee.aspx.cs" Inherits="HRMSAdminModule.CreateEmployee" %>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox1" class="form-control input-default" runat="server" placeholder="FirstName"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox2" runat="server" class="form-control input-flat" placeholder="LastName"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox3" runat="server" class="form-control input-flat" placeholder="Email"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox4" runat="server" class="form-control input-flat" placeholder="Contact"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox5" runat="server" class="form-control input-flat" placeholder="Doj" TextMode="Date"></asp:TextBox>
                                        </div>
                                        <h4>Login Credentials</h4>
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox6" runat="server" class="form-control input-flat" placeholder="username"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox7" runat="server" class="form-control input-flat" placeholder="password"></asp:TextBox>
                                        </div>

                                        <h5>Department</h5>
                                        <div class="form-group">
                                            <asp:DropDownList ID="DropDownList1" runat="server" class="form-control input-flat">
                                        ...
                                        <div class="form-group">
                                            <asp:RadioButton ID="rbActive" runat="server" GroupName="Status" Text="Active" Style="margin-right: 10px;" />
                                            <asp:RadioButton ID="rbInactive" runat="server" GroupName="Status" Text="Inactive" />
                                        </div>

                                        <div class="form-group">
                                            <asp:Button ID="Button1" runat="server" class="btn btn-dark" Text="create" OnClick="Button1_Click"  />
                                        </div>
                                    </div>
                                </div>
                            </div>
