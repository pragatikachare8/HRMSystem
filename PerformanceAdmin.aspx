<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceAdmin.aspx.cs" Inherits="HRMSAdminModule.PerformanceAdmin" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            <asp:Button ID="btnSubmit" runat="server" Text="Fetch Answers" OnClick="btnSubmit_Click" />
                                        </div>

                                        <asp:GridView ID="gvAnswers" runat="server" AutoGenerateColumns="False" BorderWidth="1px">
                                            <Columns>
