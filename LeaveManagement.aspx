<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveManagement.aspx.cs" Inherits="HRMSAdminModule.LeaveManagement" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" runat="server" CssClass="styled-gridview" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" DataSourceID="SqlDataSource2">
                                            <Columns>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:P_HRMSConnectionString3 %>" ProviderName="<%$ ConnectionStrings:P_HRMSConnectionString3.ProviderName %>" SelectCommand="SELECT * FROM [Attendance]"></asp:SqlDataSource>
